...
COPY dataset (id, authority, doiseparator, fileaccessrequest, globalidcreatetime, identifier, protocol, guestbook_id, thumbnailfile_id, citationdatedatasetfieldtype_id) FROM stdin;
\.
